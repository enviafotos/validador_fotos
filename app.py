...
archivo = st.file_uploader("Sube tu foto (Foto valida , 1.	Tamaño: 340X402 pixeles (ancho x largo), 2.	Peso y tipo de archivo: 25 a 30 kb , 3.	Fondo: La foto debe ser con fondo de color blanco , 4.	Vestimenta: Business Casual o Casual)", type=["jpg", "jpeg"])
if archivo:
