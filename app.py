...
archivo = st.file_uploader("Sube tu foto (Foto valida , 1.	Tamaño: 340X402 pixeles (ancho x largo), 2.	Peso y tipo de archivo: 25 a 30 kb y formato JPG)", type=["jpg", "jpeg"])
if archivo:
