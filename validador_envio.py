...
def validar_frontalidad(deteccion):
   rostros = deteccion.get("rostros", [])
   if len(rostros) == 0:
       return False
   return True  # Mejora futura: validar simetría de rostro
def rostro_visible(imagen_cv2, deteccion):
   return True  # Mejora futura: detección de obstrucciones (cabello, mascarilla)